...
<div class="container p-3">
    ...
    <div class="card-deck">
        <a href="barang" class="card text-white bg-primary mb-3" style="max-width: 15rem; min-width:15rem">
        ...
        <a href="kategori" class="card text-white bg-success mb-3" style="max-width: 15rem; min-width:15rem">
            <div class="card-header">
